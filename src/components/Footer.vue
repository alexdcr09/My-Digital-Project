<template>
  <footer class="bg-gray-100 text-gray-600 px-6 lg:px-8 py-12">
  <div class="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
    <div>
      <h2 class="h-8 text-5xl">logo</h2>
    </div>
    <div>
      ...
      <nav class="mt-4">
        <ul class="space-y-2">
          <li>
            <a href="#" class="font-normal text-base hover:text-gray-500">General Terms & Conditions</a>
          </li>
          <li>
    ...
    <div>
      <h5 class="text-xl font-bold text-center text-gray-700">Contact</h5>
      <div class="sp md:space-y-6 mt-4">
        ...
        <div class="flex items-start space-x-8">
          ...
          <div class="flex-1 text-left">
            <a href="#" class="hover:text-gray-500 text-left">support@Company.com</a>
          </div>
        </div>
      </div>
    </div>
    <div>
      <h5 class="text-xl font-bold text-gray-700">Newsletter</h5>
    </div>
  </div>
  <div class="max-w-screen-xl mx-auto flex flex-col items-center mt-16">
    <div class="flex items-center space-x-2">
      <a href="#" class="hover:text-gray-200">
        ...
        <svg class="h-10 w-10 text-gray-500" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
